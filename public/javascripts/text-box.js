    ...
    initialize: function() {
        ...
        if (this.isUserAdded) {
            ...
            Events.trigger('TUTORIAL', {
                ...
                'text': 'Text input uses <a href="http://grid.eckers.se/3900c" target="_blank">markdown</a> for easy formatting. For instance, try **text** to make bold text, or *text* to make it italic. Click outside your text box to view the result.',
                okCallback: function() {
                    me.edit();
                }
            });
